    ...
    class Program {
        ...
        public class LinqSamples {
            ...
            private void createLists () {
                ...
                /* 
                customerList = (
                        from e in XDocument.Load ("Customers.xml").Root.Elements ("customer") select new Customer {
                            CustomerID = (string) e.Element ("id"),
                                ...
                                Orders = (
                                    from o in e.Elements ("orders").Elements ("order") select new Order {
            ...
            public void LINQ5 () {
                string[] digits = { "zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "night", "ten" };
                var shortDigits = digits.Where ((el, index) => el.Length < index);
                foreach (var d in shortDigits) {
                    Console.WriteLine ("The word {0} is shorter thant its value.", d);
                }
            }
        }
    }
